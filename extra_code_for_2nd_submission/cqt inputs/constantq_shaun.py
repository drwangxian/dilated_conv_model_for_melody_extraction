...
def cqt(y, sr=22050, hop_length=512, fmin=None, n_bins=84,
        ...
        sparsity=0., window='hann',
        pad_mode='reflect'):
    '''
    This version has been modified by Shaun so that equal amplitudes
    in the time domain will have the same property in the frequency domain. (3 Feb 2021)
