"""
22-Nov-2021 Monday: tf2 implementation of combined frequency and periodicity (CFP)
"""
import numpy as np
import scipy.signal
import librosa
...
if __name__ == '__main__':
    ...
    tid = "AimeeNorwich_Child"
    wav_file = os.path.join(os.environ['medleydb'], tid, tid + '_MIX.wav')

    # tid = 'abjones_1'
    # wav_file = os.path.join(os.environ['mir1k'], 'UndividedWavfile', tid + '.wav')
